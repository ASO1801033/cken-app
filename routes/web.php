...
//ユーザーマイページのルート情報(ログインした人しか入られない)
...
// パスワードの更新(現在利用中のパスワードがわかる)
Route::get('/cken/password_update_in', 'CKenController@password_update_in')->middleware('auth')->name('password_update_in'); //password_update.blade.php
Route::post('/cken/password_update', 'CKenController@password_update')->middleware('auth')->name('password_update'); //password_update.blade.php
